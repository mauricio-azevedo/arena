    ...
    >
      ...
      <div className="mt-1 flex items-center gap-2">
        <input
          ...
          className="min-w-0 flex-1 border-none bg-transparent p-0 text-field font-bold text-foreground outline-none placeholder:font-medium placeholder:text-faint-foreground disabled:opacity-50"
        />
        {hasError && (
          <CircleAlert
